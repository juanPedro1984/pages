...
?>
  <article class="presentacion">
    <section class="carta">
    <h2 class="textTitulo" id="presentacion">Presentacion</h2>
    <p>
      ...
      creo que los conocimientos adquiridos hasta el momento pueden ser útiles en diversos proyectos
      relacionados al desarrollo de software.
      Aún no he adquirido experiencia laboral, por lo que estoy a la expectativa
      de oportunidades para desempeñarme en el área.
    </p>
    </section>
  </article>
<?php }
